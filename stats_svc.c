...
add_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case min_max1:
		_xdr_argument = (xdrproc_t) xdr_input1;
		_xdr_result = (xdrproc_t) xdr_output1;
		local = (char *(*)(char *, struct svc_req *)) min_max1_1_svc;
		break;

	case prod_aY:
		_xdr_argument = (xdrproc_t) xdr_input2;
		_xdr_result = (xdrproc_t) xdr_output2;
		local = (char *(*)(char *, struct svc_req *)) prod_ay_1_svc;
		break;
